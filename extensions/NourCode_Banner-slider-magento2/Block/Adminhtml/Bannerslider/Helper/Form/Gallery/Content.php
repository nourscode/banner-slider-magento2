 ...
 */
namespace NourCode\Bannerslider\Block\Adminhtml\Bannerslider\Helper\Form\Gallery;
...
class Content extends \Magento\Catalog\Block\Adminhtml\Product\Helper\Form\Gallery\Content
{
    ...
    public function __construct(
        ...
        \NourCode\Bannerslider\Model\Bannerslider\Media\Config $mediaConfig,
        array $data = []
    ) {
    ...
    protected function _prepareLayout()
    {
        ...
        $this->getChildBlock('uploader')->setTemplate('NourCode_Bannerslider::media/uploader.phtml');
        // $this->addChild(
        //     'uploader',
        //     'Magento\Backend\Block\Media\Uploader',
        //     [
        //         'template' => 'NourCode_Bannerslider::media/uploader.phtml'
        //     ]
        // );
