...
namespace NourCode\Bannerslider\Controller\Adminhtml;
...
abstract class Action extends \Magento\Backend\App\Action
{
     ...
     * @var string
     */
    // protected $_modelClass      = 'NourCode\Bannerslider\Model\Bannerslider';
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed("NourCode_Bannerslider::bannerslider_$action");
    }
}
